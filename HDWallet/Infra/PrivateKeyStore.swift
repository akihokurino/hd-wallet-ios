...
struct ExternalPrivateKeyStore {
    private let serviceKey = "external-accounts"
    private let accountKey = "hd-wallet"

    static let shared = ExternalPrivateKeyStore()
    private init() {}
...
struct InternalPrivateKeyStore {
    private let serviceKey = "internal-accounts"
    private let accountKey = "hd-wallet"

    static let shared = InternalPrivateKeyStore()
    private init() {}
